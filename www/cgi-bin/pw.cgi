...
case "$task" in
    ...
    "state")
        ...
        latest_version=$(wget -qO- "https://raw.githubusercontent.com/Master-s/PPPwn_ow_AR/main/version" 2>/dev/null)
    ...
    "update")
        ...
        echo ""
        "$(wget -O /tmp/installer.sh https://raw.githubusercontent.com/Master-s/PPPwn_ow_AR/main/installer.sh)"
